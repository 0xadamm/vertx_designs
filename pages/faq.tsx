...
import Contactus from "../components/ContactNow";
...
const FAQs = () => {
	...
	return (
		<div>
			<Head>
				<title>FAQs | Vertx Designs</title>
			</Head>
						...
						<div className="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
							...
							>
								...
								>
									...
									/>
									<path
										d="M207.497 132.461L191.537 147.385"
										stroke="white"
										strokeWidth="0.75"
										strokeLinecap="round"
										strokeLinejoin="round"
									/>
									<path
										d="M137.075 232.448L125.203 214.08"
										stroke="white"
										strokeWidth="0.75"
										strokeLinecap="round"
										strokeLinejoin="round"
