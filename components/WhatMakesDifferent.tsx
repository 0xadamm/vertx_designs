...
const WhatMakesDifferent = () => {
  ...
  return (
    <div className="relative mx-auto my-14 border-[10px] border-transparent bg-black py-14 dark:border-black dark:bg-gray-dark lg:my-[100px] lg:py-[100px] xl:max-w-[1440px] xl:rounded-3xl">
            ...
            <div className="grid gap-x-7 gap-y-12 sm:grid-cols-2" data-aos={isRtl ? 'fade-left' : 'fade-right'} data-aos-duration="1000">
              <div className="flex transition">
                ...
                <div className="ltr:pl-3 rtl:pr-3">
                  ...
                  <p className="font-semibold">Unleashing imagination to craft unique, captivating experiences.</p>
                </div>
              </div>
              <div className="flex transition">
                <div>
                ...
                <div className="ltr:pl-3 rtl:pr-3">
                  ...
                  <p className="font-semibold">Pioneering ideas that challenge boundaries and spark growth.</p>
                </div>
              </div>
              <div className="flex transition">
                <div>
                ...
                <div className="ltr:pl-3 rtl:pr-3">
                  ...
                  <p className="font-semibold">Swift, efficient problem-solving for exceptional results.</p>
                </div>
              </div>
              <div className="flex transition">
                <div>
                ...
                <div className="ltr:pl-3 rtl:pr-3">
                  <h4 className="mb-2 text-lg font-bold text-white">Top-Tier Support</h4>
                  <p className="font-semibold">Dedicated, personalized assistance to ensure client success.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="top-1/2 mx-auto mt-10 ltr:right-5 rtl:left-5 md:w-[45%] lg:mt-0 xl:absolute xl:-translate-y-1/2">
            <Image width={600} height={450} src="/assets/images/box-img.png" alt="box-img" className="w-full rtl:rotate-y-180" />
          </div>
        </div>
      </div>
    </div>
