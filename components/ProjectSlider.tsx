		...
		<section className="py-15 lg:py-[100px]">
			<div className="container">
				...
				{/* <div className="overflow-x-auto">
					<ul className="mb-10 mt-10 flex w-[700px] gap-8 font-bold md:w-auto lg:mt-0 lg:gap-10">
						<li className="text-secondary">
							<button type="button">All Work</button>
						</li>
						<li>
							<button
								type="button"
							...
							<SwiperSlide key={project.id}>
								<div className="relative rounded-3xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark">
									...
									<div className="p-5 text-sm font-bold">
										<h6 className="mb-1 line-clamp-1 text-black dark:text-white">
											{project.title}
										</h6>
										<p>{project.tag}</p>
									</div>
