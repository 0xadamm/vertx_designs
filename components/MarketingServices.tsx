...
const MarketingServices = () => {
	return (
		<section className="mb-10 mt-14 md:mt-20">
			<div className="container">
				<div className="heading mb-12 text-center md:!mb-[90px] lg:max-w-[584px] ltr:lg:text-left rtl:lg:text-right">
					<h4 className="!font-black">
						...
						services to grow your startup
					</h4>
					<p className="mt-5 text-lg font-medium">
						Empower your startup with cutting-edge marketing
						strategies designed to drive growth, boost visibility,
						and captivate your target audience for maximum impact.
					</p>
				</div>
				<div
				...
				>
					<div className="rounded-[10px] border-2 border-transparent bg-white p-[30px] shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] duration-200 hover:border-2 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark dark:shadow-none">
						...
						<h3 className="mt-7 text-[22px] font-extrabold text-black dark:text-white">
							Campaign Strategy
						</h3>
