      ...
      <div className="container">
        <div className="relative">
          <div className="relative xl:inline-block" data-aos="fade-down" data-aos-duration="1000">
            <Image width={120} height={230} src="/assets/images/stay-text.png" alt="Stay" className="left-1/2 mx-auto sm:absolute sm:-translate-x-1/2" />
            <Image width={900} height={225} src="/assets/images/updated-text.png" alt="Update" className="mx-auto sm:pt-4 xl:mx-0" />
            <div className="top-20 ltr:left-[105%] rtl:right-[105%] xl:absolute">
              <svg width="320" height="282" viewBox="0 0 320 282" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto my-8 w-[90%] sm:w-auto">
                <path
                ...
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M290.599 92.5821L193.561 108.211L157.692 38.6367" stroke="#7780A1" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path
                ...
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M311.749 67.8984L305.801 88.3553" stroke="#7780A1" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
          ...
          <form action="" className="relative z-[1] pt-[50px] text-center ltr:xl:text-left rtl:xl:text-right" data-aos="fade-up" data-aos-duration="1000">
