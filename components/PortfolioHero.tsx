        ...
        <div className="container">
          <div className="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
            ...
            <div className="relative" data-aos={isRtl ? 'fade-right' : 'fade-left'} data-aos-duration="1000">
              <svg width="302" height="300" viewBox="0 0 302 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto rtl:rotate-y-180 md:mx-0">
                <path
                ...
                <path
                  ...
                  fill="#47BDFF"
                />
                <path d="M172.995 113.481C173.265 114.877 173.689 116.239 174.258 117.542C179.159 115.105 178.016 113.511 172.995 113.481Z" fill="#47BDFF" />
                <path
                ...
                <path d="M113.186 151.324L117.607 154.001" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M136.49 172.592L184.24 201.591" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M137.453 166.064L187.278 196.358" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path
                ...
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M23.8353 222.761L19.1901 228.787" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M147.587 290.758L163.583 291.24" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M265.786 208.415L279.11 215.972" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M233.26 264.856L245.221 271.836" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M250.995 275.476L259.865 280.65" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M285.304 219.852L294.354 224.997" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M257.219 241.06L286.357 258.297" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M136.641 166.426L133.183 167.72L136.34 176.774" stroke="white" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                <path
