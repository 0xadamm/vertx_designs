			...
			<div className="container">
				<div className="grid items-center gap-5 md:gap-10 lg:grid-cols-2">
					<div className="heading text-center ltr:lg:text-left rtl:lg:text-right">
						<h6>How We Do It?</h6>
						<h4>
							We ensure stress-free spending, allowing you to
					...
					<div className="grid gap-4 rounded-[32px] sm:grid-cols-2 sm:gap-0">
						...
						>
							...
							<div>
								...
								<p className="line-clamp-6 text-sm font-bold leading-5 opacity-80">
									The very first step that we follow while developing
									apps or working on any project, begins with
									analysis.
								</p>
							</div>
						</div>
						...
						>
							...
							<div>
								...
								<p className="line-clamp-6 text-sm font-bold leading-5 opacity-80">
									Designing helps us understand the engagement of
									users if the product is user-friendly, intuitive,
									and reciprocal.
								</p>
							</div>
						</div>
						...
						>
							...
							<div>
								...
								<p className="line-clamp-6 text-sm font-bold leading-5 opacity-80">
									...
									surrounds a significant section of our overall
